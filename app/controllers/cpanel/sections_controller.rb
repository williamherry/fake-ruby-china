class Cpanel::SectionsController < Cpanel::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @section.save
        format.html { redirect_to [:cpanel, @section], notice: 'Section was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @section.update(section_params)
        format.html { redirect_to [:cpanel, @section], notice: 'Section was successfully updated.' }
